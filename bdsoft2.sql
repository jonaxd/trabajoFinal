...
CREATE TABLE `tbinscritos` (
  ...
  CONSTRAINT `idtbpartido` FOREIGN KEY (`idpartido`) REFERENCES `tbpartidos` (`idtbpartido`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idusuario` FOREIGN KEY (`idusuario`) REFERENCES `tbusuario` (`usuarioID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tbinscritos` VALUES (1,1,20),(2,1,21),(3,2,22),(4,2,23);
...
INSERT INTO `tbusuario` VALUES (20,'Miguel','54632178','Masculino',998765432,'Delantero'),(21,'Jonatan','85274196','Masculino',963258741,'Portero'),(22,'Juan','12345678','Masculino',987654321,'Defensa'),(23,'Mario','32589614','Masculino',5555555,'Defensa');
...
-- Dump completed on 2014-11-19  8:57:46
